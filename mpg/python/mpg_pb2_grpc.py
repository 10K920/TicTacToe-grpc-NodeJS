...
class TicTacToeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PlayTurn = channel.unary_unary(
                ...
                request_serializer=mpg__pb2.PlayerMove.SerializeToString,
                response_deserializer=mpg__pb2.CurrentBoard.FromString,
                )
...
def add_TicTacToeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PlayTurn': grpc.unary_unary_rpc_method_handler(
                    servicer.PlayTurn,
                    request_deserializer=mpg__pb2.PlayerMove.FromString,
                    response_serializer=mpg__pb2.CurrentBoard.SerializeToString,
            ),
    }
...
class TicTacToe(object):
    ...
    def PlayTurn(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/mpg.TicTacToe/PlayTurn',
            mpg__pb2.PlayerMove.SerializeToString,
            mpg__pb2.CurrentBoard.FromString,
